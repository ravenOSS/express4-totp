...
var session = require('express-session'); // need to add session store not inmemory
...
var users = [
  ...
  { id: 3, username: 'sue', password: 'smith', email: 'sue@example.com' },
  { id: 4, username: 'liz', password: 'olde', email: 'liz@example.com' },
  { id: 5, username: 'jane', password: 'horse', email: 'jane@example.com' },
  { id: 6, username: 'tom', password: 'harry', email: 'tom@example.com' }
];
...
app.use(session({
  secret: '>+<<NNBLKJH>>G@@FDAqw~wet))tyuio))((*&%$#',
  resave: true,
